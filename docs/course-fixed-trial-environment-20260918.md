...
> 2026/09/20 決策取代：以下為歷史提案，不得執行。停止新增付費 Vercel／Supabase 試用專案。9/30 對外交付使用正式環境的正式店家與體驗版方案；隔離驗收沿用既有環境及 A 店。相關獨立設定檔僅保留歷史，不接入目前部署。有效計畫見 `course-production-trial-lifecycle-20260920.md` 及 `course-pilot-delivery-20260930.md`。
