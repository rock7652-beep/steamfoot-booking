...
營運分析按「預約建立日期」選取一批體驗預約，顯示其預約組數、來源占比、預約人數、後續完成服務人次、到店率，以及已指派正式套餐顧客與方案轉換率。來源占比＝該來源預約組數÷本期全部體驗預約組數；到店率＝完成服務人次÷預約人數；方案轉換率＝已指派正式套餐顧客÷完成服務且已建檔的顧客。取消與未到保留在預約分母，但不列入到店或方案。指派方案不代表款項已確認收訖。過去資料不回填來源，以免把已綁 LINE 的 Google 地圖顧客
