...
ALTER TABLE "DigitalButlerFlowVersion" ADD CONSTRAINT "DigitalButlerFlowVersion_flowId_fkey" FOREIGN KEY ("flowId") REFERENCES "StoreDigitalButlerFlow"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "StoreDigitalButlerFlow" ADD CONSTRAINT "StoreDigitalButlerFlow_currentPublishedVersionId_fkey" FOREIGN KEY ("currentPublishedVersionId") REFERENCES "DigitalButlerFlowVersion"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "DigitalButlerStep" ADD CONSTRAINT "DigitalButlerStep_flowVersionId_fkey" FOREIGN KEY ("flowVersionId") REFERENCES "DigitalButlerFlowVersion"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "DigitalButlerConversation" ADD CONSTRAINT "DigitalButlerConversation_flowId_fkey" FOREIGN KEY ("flowId") REFERENCES "StoreDigitalButlerFlow"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "DigitalButlerConversation" ADD CONSTRAINT "DigitalButlerConversation_flowVersionId_fkey" FOREIGN KEY ("flowVersionId") REFERENCES "DigitalButlerFlowVersion"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "DigitalButlerAnswer" ADD CONSTRAINT "DigitalButlerAnswer_conversationId_fkey" FOREIGN KEY ("conversationId") REFERENCES "DigitalButlerConversation"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "DigitalButlerAnswer" ADD CONSTRAINT "DigitalButlerAnswer_stepId_fkey" FOREIGN KEY ("stepId") REFERENCES "DigitalButlerStep"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "DigitalButlerLead" ADD CONSTRAINT "DigitalButlerLead_flowId_fkey" FOREIGN KEY ("flowId") REFERENCES "StoreDigitalButlerFlow"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "DigitalButlerLead" ADD CONSTRAINT "DigitalButlerLead_conversationId_fkey" FOREIGN KEY ("conversationId") REFERENCES "DigitalButlerConversation"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
