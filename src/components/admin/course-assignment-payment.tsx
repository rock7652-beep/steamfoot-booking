...
export function CourseAssignmentPayment({price,canDiscount}:{price:number;canDiscount:boolean}) {
 ...
 <input type="hidden" name="expectedListPrice" value={price}/><p className="sm:col-span-2">方案售價 NT$ {price.toLocaleString()}</p>
 ...
 {!canDiscount&&<input type="hidden" name="discountKind" value="AMOUNT"/>}
