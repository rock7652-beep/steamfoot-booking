...
export async function NoPlanEmptyState({ title, variant = "booking", shopHref = "/book/shop" }: Props) {
  const context = await getStoreContext();
  const presentation = context ? await resolveStorePresentation(context.storeSlug) : null;
  const contactUrl = presentation?.contactUrl;
