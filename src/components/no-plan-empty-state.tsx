    ...
    <div>
      {title && (
        <div className="mb-4 flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold text-earth-900">{title}</h1>
        </div>
      )}
      ...
      <div className="rounded-2xl bg-white p-8 text-center shadow-[0_1px_3px_rgba(0,0,0,0.06)]">
        ...
        <p className="text-base font-semibold text-earth-800">{headline}</p>
        <p className="mt-2 text-sm leading-relaxed text-earth-500 whitespace-pre-line">
          {description}
        </p>
        ...
        <div className="mt-6 space-y-2">
          <a
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#06C755] py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-[#05b54d] active:scale-[0.98]"
          >
          ...
          <Link
            href="/my-plans"
            className="flex w-full items-center justify-center rounded-xl border border-earth-200 bg-white py-2.5 text-sm font-medium text-earth-700 hover:bg-earth-50"
          >
            {secondaryLabel}
          </Link>
        </div>
