...
export function PlanPackageNotes() {
  return (
    <section className="rounded-xl border border-earth-200 bg-white p-5 text-sm leading-relaxed text-earth-700">
      ...
      <p className="mt-3">展店版每月 $4,990，含總部管理及首間分店串接。{ALLIANCE_BRANCH_PRICING_COPY} 各分店另購基本版 $1,490／月或專業版 $2,490／月。串接幾間，就付幾間的串接費；例如 6 間分店的串接費共 $2,300／月。</p>
      ...
      <ul className="mt-2 list-disc space-y-1 pl-5">
        ...
        <li>經營型模組：顧客經營、健康評估與體態追蹤、月結管理、分析；額外加購每個 NT$800／月。</li>
        <li>額度內選配不另收費；展店版總部包含適用模組，分店仍依各自購買的方案開通。數位管家需個別確認開通，不列入上述全含範圍。</li>
        <li>專業版：提醒／匯出再選 1 項；健康／月結／分析再選 1 項。固定內含功能不占名額，選定後由總部協助開通。</li>
      </ul>
