/**
 * Tests for scripts/repair-line-mismatch-pr-f2-2.ts (PR-F2.2).
 *
...
} from "../../scripts/repair-line-mismatch-pr-f2-2";
...
const SCRIPT_PATH = join(
  ...
  "..",
  "scripts",
  "repair-line-mismatch-pr-f2-2.ts",
);
...
describe("repair-line-mismatch-pr-f2-2 script (source-text contract)", () => {
