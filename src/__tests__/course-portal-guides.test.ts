...
describe("course portal guide access and search", () => {
  it("keeps member and coach instructions separate", () => {
    expect(findCoursePortalGuides("member", true)).toHaveLength(10);
    expect(findCoursePortalGuides("coach", true)).toHaveLength(6);
  ...
  it("hides health instructions when the feature is unavailable", () => {
    expect(findCoursePortalGuides("member", false)).toHaveLength(9);
