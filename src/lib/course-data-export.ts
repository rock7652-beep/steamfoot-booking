...
export const COURSE_EXPORT_LABELS: Record<DataExportType, string> = {
  customers: "顧客資料", transactions: "課程購買、體驗與退款", bookings: "課程預約與出席", wallets: "課程方案與額度",
};
...
export const COURSE_EXPORT_PERIOD_LABELS: Record<DataExportType, string> = {
  customers: "顧客建立期間", transactions: "購買／體驗收款與沖銷／退款期間（分頁列示，非營收加總）", bookings: "上課日期期間", wallets: "發卡日期期間",
};
