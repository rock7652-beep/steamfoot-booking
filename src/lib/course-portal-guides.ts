...
export const coursePortalGuides: CoursePortalGuide[] = [
  ...
  { id: "CP17", role: "coach", title: "教練如何查看本人已確認收入？", keywords: "我的收入 月結 授課費 應領 LINE 付款",
    steps: ["在正確店家的「我的工作」點「我的收入 · 查看已確認月結」，再選月份。", "核對應領合計、我的授課費及本人有的店長利潤，展開項目查看日期。", "顯示金額調整中時，以下仍為上次確認金額；歷史付款紀錄另外展開核對。"],
    note: "店長需先開放本人收入查詢並完成帳號連結；未確認不代表零元。只能查看本人資料，LINE 提醒或店家登記付款不代表實際到帳。沒有入口請店家核對，不另建帳號。" },
  { id: "CP18", role: "member", title: "已連結店內人員，如何查看我的收入？", keywords: "我的收入 人員 店長利潤 月結 LINE 付款",
    steps: ["僅已連結本店在職人員、且店長開放本人查詢的帳號，才有收入入口；一般會員不適用。", "沒有教練工作身分時，進「我的 → 我的收入」選月份；同時有教練身分則改從我的工作進入。", "查看本人已確認項目；本月待店長確認時先等候，金額調整中保留上次確認值。需要時展開歷史付款紀錄。"],
    note: "查詢預設關閉，入口缺少請店家核對人員連結與開放設定；不是申請店長權限的入口。應領合計、LINE 通知與登記付款皆不代表銀行已入帳，也不能查看其他人員收入。" },
];
