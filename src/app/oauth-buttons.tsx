...
export function OAuthButtons() {
  return (
    <div className="space-y-3">
      ...
      <button
        type="button"
        onClick={() => signIn("line", { callbackUrl: "/book" })}
        className="flex w-full items-center justify-center gap-2 rounded-lg bg-[#06C755] px-4 py-2.5 text-sm font-medium text-white hover:bg-[#05b04c] transition"
      >
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded-lg border border-earth-300 bg-white px-4 py-2.5 text-sm font-medium text-earth-700 hover:bg-earth-50 transition"
      >
