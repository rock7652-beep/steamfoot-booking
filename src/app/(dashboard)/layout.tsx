...
export default async function DashboardLayout({
  ...
  if (industryModule === "course") {
    ...
    if (!/\/dashboard\/?$/.test(requestedPath) && !/\/dashboard\/(?:courses(?:\/|$)|staff(?:\/[^/]+\/edit)?\/?$|cashbook(?:\/new|\/[^/]+\/edit)?\/?$|cash-drawer\/?$|revenue\/?$|reconciliation\/?$|store-revenue\/?$|guide\/?$)/.test(requestedPath)) {
