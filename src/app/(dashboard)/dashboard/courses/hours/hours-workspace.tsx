...
export function CourseHoursWorkspace({ booking, schedule, initialSection }: { booking: ReactNode; schedule: ReactNode; initialSection?: string }) {
  const [section, setSection] = useState(initialSection === "special" ? "special" : initialSection === "booking" ? "booking" : "weekly");
  return <div>
