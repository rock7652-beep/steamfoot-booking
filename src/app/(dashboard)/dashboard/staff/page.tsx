  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border bg-white p-6 shadow-sm">
        <h2 className="mb-4 text-lg font-bold text-gray-900">新增店長</h2>
        ...
        <form action={handleCreateStaff} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          {/* Color Code */}
          <div>
            <label className="block text-sm font-medium text-gray-700">顏色代碼（選填）</label>
            <input
              type="color"
              name="colorCode"
              defaultValue="#6366f1"
      ...
      {/* Staff List Card */}
      <div className="rounded-xl border bg-white p-6 shadow-sm">
        <h2 className="mb-4 text-lg font-bold text-gray-900">店長列表</h2>

        {staffList.length === 0 ? (
          <p className="text-gray-400">暫無店長</p>
        ) : (
            ...
            <table className="min-w-full divide-y divide-gray-200 text-sm">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left font-medium text-gray-600">顧客數</th>
                  ...
                  <tr key={staff.id} className="hover:bg-gray-50">
                    <td className="px-4 py-3">
                      <div>
                        ...
                        <div className="text-xs text-gray-500">{staff.user.name}</div>
                      </div>
                    </td>
                    <td className="px-4 py-3 text-gray-600">{staff.user.email}</td>
