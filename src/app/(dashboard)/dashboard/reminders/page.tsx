      ...
      <PageShell>
        ...
        {activeTab === "rules" && (
          <section className="grid gap-4 lg:grid-cols-2">
            <div className="rounded-xl border border-earth-200 bg-white p-4 shadow-sm lg:col-span-2">
            ...
            <details className="group rounded-xl border border-earth-200 bg-white shadow-sm lg:col-span-2">
