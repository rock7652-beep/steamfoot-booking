  ...
  return <div className="min-h-screen bg-[#F8F5EE] text-[#153B31]">
    ...
    <main id="plans" className="mx-auto max-w-6xl px-5 py-8 sm:px-8 sm:py-10">
      ...
      <section aria-labelledby="addons" className="mt-8 border-t border-[#153B31]/15 pt-6">
        ...
        <div className="mt-4 rounded-xl border border-[#153B31]/15 bg-white p-4"><h3 className="text-base font-semibold">分析 <span className="ml-2 font-normal">NT$800／月</span></h3><p className="mt-2 leading-7 text-[#4C6259]">查看營收、來客、開卡轉換、回店與變化趨勢。各方案皆可獨立加購，不占選配額度；由總部依門市開通，關閉保留歷史資料。</p></div>
