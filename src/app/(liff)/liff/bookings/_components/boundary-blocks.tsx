...
/**
 * Loading + InfoBlock 從 bookings-list.tsx 拆出 (P1-5a 結構拆分).
 *
 * 為何不抽 shared 元件給其他 LIFF 頁共用：
 *   - 這檔的 InfoBlock 多收 `storeSlug` 並渲染「回首頁」Link，
 *     liff-shell.tsx / trial-booking-form.tsx 的版本沒有
 *   - 既有 LIFF codebase 採「duplicate over abstraction」pattern
 *     （per liff-shell.tsx LineIcon 等 inline 註解）
 *
 * 純 presentational：props in、JSX out，不持有任何 state 或 side effect
