    ...
    <main className="flex min-h-dvh flex-col items-center justify-center bg-gradient-to-b from-primary-50 to-earth-50 px-4">
      <div className="w-full max-w-sm text-center">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold text-earth-900">蒸足預約管理系統</h1>
          <p className="mt-2 text-sm text-earth-500">輕鬆管理預約、課程方案與營收報表</p>
        </div>

        {/* CTA - 登入系統 */}
        <Link
          href="/login"
          className="block w-full rounded-xl bg-primary-600 px-6 py-3.5 text-base font-semibold text-white shadow-sm transition hover:bg-primary-700 active:bg-primary-800"
        >
          登入系統
        </Link>
        ...
        <div className="mt-8 grid grid-cols-3 gap-3">
          <Link
            ...
            className="flex flex-col items-center gap-2 rounded-xl border border-earth-200 bg-white p-4 shadow-sm transition hover:border-primary-300 hover:shadow-md active:bg-earth-50"
          >
        ...
        <p className="mt-6 text-xs text-earth-400">客戶可使用 Google 帳號快速登入</p>
      </div>
    </main>
  );
}
