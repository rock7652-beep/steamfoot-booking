...
const EXPECTED_MIGRATION =
  "20260727190000_add_session_balance_notification_settings";
const PROD_REF = "qijlnhtpbintanzpxkvf";
const STAGING_REF = "ttworfzgwejdeolegkxl";
const log = (message) => console.log(`[ci-migrate-renewal-settings] ${message}`);
...
function main() {
  ...
  if (databaseRef !== PROD_REF || directRef !== PROD_REF) {
    throw new Error("Production build is not connected to the approved database");
  }
